 ...
 */
public class CategoriasPrendasFXMLController implements Initializable {
    @FXML
    ...
    public void setData(Usuario usuario){       
        ...
        respuesta = Requests.get("/categoriaprenda/getAllCategoriaPrenda/");
        Gson gson = new Gson();
    ...
    private void agregarCategoria(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/sistemaempfx/gui/view/AgregarCategoriaPrendasFXML.fxml"));

            Parent usuarios = loader.load();

            AgregarCategoriaPrendasFXMLController ctrl = loader.getController();
            ctrl.setData(null);
        ...
        this.categoria= tb_categorias.getSelectionModel().getSelectedItem();
         if (this.categoria != null) {
            try {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/sistemaempfx/gui/view/EditarCategoriaPrendasFXML.fxml"));

                Parent formUsuarioEditar = loader.load();

                EditarCategoriaPrendasFXMLController ctrl = loader.getController();
                ...
                if (response == ButtonType.OK) {
                    ...
                    try {
                        ...
                        if ("Inactivo".equals(estado)) {
                            ...
                            String respuesta = Requests.put("/categoriaprenda/actualizarEstatusPrenda/" + categoria.getIdCategoria(), params);
                ...
                if (response == ButtonType.OK) {
                    ...
                    try {
                        ...
                        if ("Activo".equals(estado)) {
                            HashMap<String, Object> params = new LinkedHashMap<>();
                            params.put("idCategoria", this.categoria.getIdCategoria());
                            String respuesta = Requests.delete("/categoriaprenda/eliminarCategoriaPrenda/" + categoria.getIdCategoria(), params);
    ...
    private void buscarCategoria(ActionEvent event) {
        ...
        respuesta = Requests.get("/categoriaprenda/buscarCategoriaPrenda/" + buscar);
        Gson gson = new Gson();
    ...
    private void limpiarCategoria(ActionEvent event) {
     ...
     private void tablaCatalogo() {
        ...
        //respuesta = Requests.get("/usuario/getAllUsers/");
        respuesta = Requests.get("/catalogoprenda/getAllCatalogoPrenda/");
        Gson gson = new Gson();
    ...
    private void agregarCatalogo(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/sistemaempfx/gui/view/AgregarCatalogosPrendasFXML.fxml"));

            Parent usuarios = loader.load();

            AgregarCatalogosPrendasFXMLController ctrl = loader.getController();
            ctrl.setData(null);
    ...
    private void editarCatalogo(ActionEvent event) {
         ...
         if (this.catalogo != null) {
            try {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/sistemaempfx/gui/view/EditarCatalogoPrendasFXML.fxml"));

                Parent formUsuarioEditar = loader.load();

                EditarCatalogosPrendasFXMLController ctrl = loader.getController();
    ...
    private void buscarCatalogo(ActionEvent event) {
        ...
        respuesta = Requests.get("/catalogoprenda/buscarCatalogoPrenda/" + buscar);
        Gson gson = new Gson();
                ...
                if (response == ButtonType.OK) {
                    ...
                    try {
                        ...
                        if ("Activo".equals(estado)) {
                            ...
                            String respuesta = Requests.delete("/catalogoprenda/eliminarCatalogoPrenda/" + catalogo.getIdCatalogo(), params);
                ...
                if (response == ButtonType.OK) {
                    ...
                    try {
                        ...
                        if ("Inactivo".equals(estado)) {
                            HashMap<String, Object> params = new LinkedHashMap<>();
                            params.put("idCatalogo", this.catalogo.getIdCatalogo());
                            String respuesta = Requests.put("/catalogoprenda/actualizarEstatusPrenda/" + catalogo.getIdCatalogo(), params);
