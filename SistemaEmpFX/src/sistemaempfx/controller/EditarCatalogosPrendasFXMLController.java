 ...
 * @author Alicia
 */
public class EditarCatalogosPrendasFXMLController implements Initializable {
                    ...
                    if (response == ButtonType.OK) {
                        try {
                            if (this.usuario.getRol().equals("Administrador")) {
                                String respuesta = Requests.put("/catalogoprenda/actualizarCatalogoPrenda/" + catalogo.getIdCatalogo(), params);
                            ...
                            Logger.getLogger(EditarCatalogosPrendasFXMLController.class.getName()).log(Level.SEVERE, null, ex);
                        }
                    }
