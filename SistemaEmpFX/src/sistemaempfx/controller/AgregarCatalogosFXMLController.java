    ...
    private void agregarCatalogo(ActionEvent event) {
        ...
        if (this.txt_catalogo.getText().isEmpty() || position <= -1) {
            ...
            try {
                ...
                verificacion = Requests.post("/catalogo/catalogoId/", buscar);
                ...
                if (dataJsonV.getString("mensaje").equals("0")) {
                    ...
                    String respuesta = Requests.post("/catalogo/registrarCatalogo/", params);
                ...
                Logger.getLogger(AgregarCatalogosFXMLController.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
