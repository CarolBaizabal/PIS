 ...
 * @author Alicia
 */
public class EditarCategoriaPrendasFXMLController implements Initializable {
                    ...
                    if (response == ButtonType.OK) {
                        try {
                            if (this.usuario.getRol().equals("Administrador")) {
                                String respuesta = Requests.put("/categoriaprenda/actualizarCategoriaPrenda/" + categoria.getIdCategoria(), params);
                            ...
                            Logger.getLogger(EditarCategoriaPrendasFXMLController.class.getName()).log(Level.SEVERE, null, ex);
                        }
                    }
