 ...
 */
public class AgregarCategoriaPrendasFXMLController implements Initializable {
    ...
    private void agregarCategoria(ActionEvent event) {
        ...
        if (this.txt_agregaCategoria.getText().isEmpty()){
            ...
            try {
                ...
                verificacion = Requests.post("/categoriaprenda/categoriaPrendaId/", buscar);
                ...
                if (dataJsonV.getString("mensaje").equals("0")) {
                    ...
                    String respuesta = Requests.post("/categoriaprenda/registrarCategoriaPrenda/", params);
                ...
                Logger.getLogger(AgregarCategoriaPrendasFXMLController.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
